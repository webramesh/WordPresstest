...
function testtheme_scripts()
{
	...
	wp_enqueue_script('popper', get_stylesheet_directory_uri() . '/assets/js/popper.js', array(), _S_VERSION, true);
	wp_enqueue_script('bootstrap', get_stylesheet_directory_uri() . '/assets/js/bootstrap.min.js', array(), _S_VERSION, true);
